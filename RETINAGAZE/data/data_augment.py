...
def _crop(image, boxes, labels, landm, gaze_labels, gaze, img_dim):
	...
	# make sure that the cropped image contains at least one face > 16 pixel at training image scale
        ...
        return image_t, boxes_t, labels_t, landms_t, gaze_labels_t, gazes_t, pad_image_flag
    return image, boxes, labels, landm, gaze_labels, gaze, pad_image_flag
...
class preproc(object):
    ...
    def __call__(self, image, targets): # !!! landmark changes as scale changes, but gaze is not ??? also box_utils
        ...
        targets_t = np.hstack((boxes_t, landm_t, labels_t, gaze_t, gaze_labels_t))
