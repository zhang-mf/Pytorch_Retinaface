...
parser.add_argument('--training_dataset', default='../../data/dataset/Face/retinaface/widerface/train/label.txt', help='Training dataset directory')
...
with torch.no_grad():
    ...
    # first anchor: tensor([0.0063, 0.0063, 0.0250, 0.0250], device='cuda:0')
...
def train():
    ...
    for iteration in range(start_iter, max_iter):
        ...
        out = net(images)
        # (torch.Size([32, 16800, 4]), torch.Size([32, 16800, 2]), torch.Size([32, 16800, 10])) # batch 32, 16800 anchors, for each anchor predict bbox 4, class 2, landmark 10
        ...
        if ((iteration % epoch_size) + 1) % 125 == 0 or iteration < 25:
